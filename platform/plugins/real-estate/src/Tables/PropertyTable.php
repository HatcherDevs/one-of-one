...
class PropertyTable extends TableAbstract
{
    ...
    public function buttons(): array
    {
        ...
        if ($this->hasPermission('tools.data-synchronize.import.properties.index')) {
            $buttons['import'] = [
                'link' => route('tools.data-synchronize.import.properties.index'),
                'text' =>
        ...
        if ($this->hasPermission('tools.data-synchronize.export.properties.index')) {
            $buttons['export'] = [
                'link' => route('tools.data-synchronize.export.properties.index'),
                'text' =>
